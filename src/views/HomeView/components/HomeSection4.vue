...
<template>
  <div  class="bg-gray-100 text-gray-900">
    <div class="relative mx-auto px-40 py-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-5">
        ...
        <div class="col-span-2 mb-10 flex flex-col border border-neutral-07 rounded-2xl p-6 text-center lg:mb-0 lg:mr-10">
          <div class="mb-4">
            ...
            <div class="mb-3 flex content-center rounded-full text-white">
              <img :src="iconList[0]" class="h-[96px] w-[96px]" />
            </div>
            <h3 class="mb-2 text-left text-lg font-semibold">WEB 3</h3>
            <p class="text-left text-xs text-neutral-05">Web3.0 打造由代幣經濟驅動的互聯網，新數字將協助你與你的企業打造 Web3 新藍海。</p>
          </div>
        ...
        <div class="col-span-3 flex flex-col border border-neutral-07 rounded-2xl p-6 text-center">
          <div class="mb-4">
            <!-- Replace this div with actual icon -->
            <div class="mb-3 rounded-full text-white">
              <img :src="iconList[1]" class="h-[96px] w-[96px]" />
            </div>
            <h3 class="mb-2 text-left text-lg font-semibold">遊戲</h3>
            <p class="text-left text-left text-xs text-neutral-05">我們致力於打造自有 IP 以打通遊戲、影視娛樂、商品周邊產業的全方位經紀公司，提供獨特的核心玩法、精緻的美術風格和令人難以抗拒的遊戲機制。</p>
          </div>
      ...
      <div class="grid grid-cols-1 mt-10 lg:grid-cols-5">
        ...
        <div class="col-span-2 col-span-3 mb-10 flex flex-col border border-neutral-07 rounded-2xl p-6 text-center lg:mb-0 lg:mr-10">
          <div class="mb-4">
            ...
            <h3 class="mb-2 text-left text-lg font-semibold">AI+</h3>
            <p class="text-left text-xs text-neutral-05">我們將「人工智能」作為當前行業科技化發展的核心特徵並提取出來，並與工業、商業、金融業各行各業全面融合。</p>
          </div>
          <div className="mt-10 flex items-center gap-x-6">
            <a
              href="#"
        ...
        <div class="col-span-2 flex flex-col border border-neutral-07 rounded-2xl p-6 text-center">
          <div class="mb-4">
            ...
            <h3 class="mb-2 text-left text-lg font-semibold">綠色行動</h3>
            <p class="text-left text-xs text-neutral-05">滿足當代人的需求又不危及後代人滿足其需求的發展，稱之為永續。我們將用科技的力量，具現化一種被人類遺忘的心能力。</p>
          </div>
          <div className="mt-10 flex items-center gap-x-6">
            <a
              href="#"
