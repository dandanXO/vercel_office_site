...
import IconCursor from '@icons/nd/cursor.svg'
import IconArrowRight from '@icons/nd/arrow-right.svg'
import lottie from '@/assets/lottie/home1.json'
...
<template>
  <div class="container">
    <div class="mt-60px flex flex-wrap lg:mt-100px lg:justify-between">
      <div class="fade-in-bottom w-full text-center lg:w-3/5">
        <div class="text-28px font-400 font-rammetto-one lg:text-56px">New Digit Defines</div>
        <div class="mt-14px text-28px font-400 font-rammetto-one lg:text-56px">
          Your&nbsp;
          <span
            class="border-4px border-primary border-rounded-40px border-solid px-16px py-6px lg:border-6px lg:px-24px lg:py-8px"
          >
            Digits
          </span>
          &nbsp;.
          <IconCursor
            class="ml-12px inline h-36px w-36px lg:ml-26px lg:h-64px lg:w-64px"
          ></IconCursor>
        </div>
        <div class="mt-24px text-26px font-700 lg:mt-40px lg:text-40px">
          探索新數位，重新定義未來
        </div>
      </div>
      <div class="mt-40px w-full lg:mt-0 lg:w-2/5">
        <!-- 官方的還有bug -->
...
.title {
  @apply text-28px font-400 font-rammetto-one lg:text-56px;
}
.fade-in-bottom {
